# Generated by Django 2.1.7 on 2019-03-06 08:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('auto_type', models.SmallIntegerField(choices=[(0, 'ssh-password'), (1, 'ssh-key')], default=0)),
        ...
        migrations.AlterUniqueTogether(
            name='remoteuser',
            unique_together={('auto_type', 'username', 'password')},
        ),
        migrations.AddField(
