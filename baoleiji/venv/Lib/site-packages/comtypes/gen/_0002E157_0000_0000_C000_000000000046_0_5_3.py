...
VBE._methods_ = [
    ...
    COMMETHOD([dispid(108), 'propget'], HRESULT, 'CommandBars',
              ( ['out', 'retval'], POINTER(POINTER(comtypes.gen._2DF8D04C_5BFA_101B_BDE5_00AA0044DE52_0_2_4.CommandBars)), 'ppcbs' )),
...
__all__ = [ '_LinkedWindows', 'vbext_pp_none', 'CodePanes',
           'vbext_rk_TypeLib', 'vbext_ProjectType', 'vbext_pk_Proc',
           '_dispVBComponentsEvents', 'vbext_RefKind', 'VBComponents',
           'Addins', 'AddIn', 'CodePane', 'vbext_wt_FindReplace',
           'LinkedWindows', 'CommandBarEvents', 'vbext_vm_Break',
           'vbext_wt_ProjectWindow', 'ReferencesEvents',
           'vbext_rk_Project', 'vbextFileTypeRes', 'vbext_vm_Run',
           'vbext_wt_MainWindow', '_VBProjectsEvents',
           'vbext_WindowState', '_VBComponents_Old',
           '_VBComponentsEvents', 'vbext_ct_MSForm',
           '_VBComponent_Old', 'vbext_wt_Designer',
           '_ProjectTemplate', '_ReferencesEvents', '_VBComponent',
           'CodeModule', 'vbext_vm_Design', 'vbext_pt_StandAlone',
           'vbextFileTypeModule', '_AddIns', '_Windows',
           '_Windows_old', '_Components', 'VBProject',
           'vbext_ws_Minimize', '_dispCommandBarControlEvents',
           'vbext_wt_CodeWindow', 'vbext_wt_Locals',
           'vbext_CodePaneview', 'Window', '_VBProject',
           'vbext_wt_Immediate', 'References', 'Reference',
           'vbextFileTypeDocObject', 'vbextFileTypeGroupProject',
           'SelectedComponents', '_VBComponents', 'Windows',
           '_VBProjects_Old', 'vbextFileTypeProject', 'Component',
           'vbextFileTypeExe', 'vbext_ct_Document',
           'vbext_ComponentType', 'vbext_pk_Get', 'vbext_wt_Toolbox',
           'vbext_pk_Let', 'vbextFileTypeFrx',
           'vbext_cv_ProcedureView', 'vbext_ws_Maximize', 'Property',
           'vbext_wt_Find', 'vbext_wt_ToolWindow',
           'vbext_pt_HostProject', 'vbext_wt_Browser', 'VBE',
           '_VBProject_Old', 'vbextFileTypes', 'vbext_pp_locked',
           'vbext_cv_FullModuleView', '_VBProjects',
           'vbextFileTypeDesigners', 'Components',
           'vbext_wt_LinkedWindowFrame', 'vbextFileTypePropertyPage',
           'Application', 'vbext_ProjectProtection', 'VBComponent',
           'vbext_ProcKind', '_References', 'vbextFileTypeForm',
           '_Properties', 'vbext_ct_StdModule',
           'vbextFileTypeUserControl', '_dispReferencesEvents',
           'ProjectTemplate', '_CommandBarControlEvents', '_CodePane',
           '_dispVBProjectsEvents', 'vbext_VBAMode',
           'vbextFileTypeBinary', '_Component',
           'vbext_ct_ActiveXDesigner', 'vbext_wt_Watch', 'VBProjects',
           'vbext_pk_Set', '_CodeModule', '_dispReferences_Events',
           '_CodePanes', 'vbext_wt_PropertyWindow', 'Properties',
           'vbext_WindowType', 'Events', 'vbextFileTypeClass',
           'vbext_ct_ClassModule', 'vbext_ws_Normal']
